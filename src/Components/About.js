...
import img01 from '../asstes/img02.png'
import Aos from 'aos'
const About = () => {
  useEffect(()=>{
    Aos.init({
  ...
  return (
      ...
      <div id='About' className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg-text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center">
        <img  data-aos = "fade-down" src={img01} width={290} className='rounded border-2 p-1 border-fuchsia-500 img_glow' alt=''/>
        ...
        <div className="flex mt-8 gap-2">
            <div className="flex items-center justify-center">
                <div className="flex space-x-2">
                    <a href="https://drive.google.com/file/d/1NAbIr6wCgWjtcee5qR4-FsGklkh9ZbkN/view?usp=drive_link" className='neno-button shadow-xl hover:shadow-fuchsia-800/50 text-white border-2 hover:bg-fuchsia-800 border-fuchsia-800 rounded-lg py-4 px-8 uppercase relative overflow-hidden'>Download CV</a>
